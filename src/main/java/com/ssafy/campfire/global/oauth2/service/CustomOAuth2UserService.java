...
//        );
    ...
    private User getUser(OAuthAttributes attributes) {
        User findUser = userRepository.findByEmailAndProvider(attributes.getOauth2UserInfo().getEmail(), attributes.getOauth2UserInfo().getProvider()).orElse(null);
    ...
    private User saveUser(OAuthAttributes attributes) {
        ...
        User createdUser = attributes.toEntity(attributes.getOauth2UserInfo(), optionalBootcamp.get());
